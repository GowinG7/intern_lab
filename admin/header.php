...
<div class="admin-sidebar d-none d-lg-flex flex-column">
    <ul class="nav flex-column mt-2">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $currentPage == 'report_form.php' ? 'active' : '' ?>" href="report_form.php">Add Report</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= $currentPage == '_reports.php' ? 'active' : '' ?>"
...
<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="adminSidebarMobile">
    <div class="offcanvas-body p-0">
        <ul class="nav flex-column mt-2">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $currentPage == 'report_form.php' ? 'active' : '' ?>"
                    href="report_form.php">Add Report</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= $currentPage == 'manage_reports.php' ? 'active' : '' ?>"
                    href="manage_reports.php">Manage reports</a>
